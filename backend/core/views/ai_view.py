    ...
    def post(self, request):
        ...
        try:
            ...
            2. **감점 기준 강화**:
               ...
               - "더 나은 문법 필요 없음" 같은 기계적인 코멘트는 작성하지 마십시오. 구체적으로 무엇이 문제인지, 혹은 완벽하다면 왜 완벽한지 설명하십시오.
